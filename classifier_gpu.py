...
from pycuda.driver import memcpy_dtoh as gputonp
...
#        print('Variance explained by the %i component:' % i, pca.explained_variance_[i]/sum(pca.explained_variance_))
    ...
    print(cupca.components_)

    pca_dict = {'projection': projection, 'label': labels_dict['label'], 'epoch': labels_dict['epoch'], 'pca': cupca}
